...
public class TestMakeEntity {
  ...
  public static ClubArticle createSampleClubArticle(CLUB_ARTICLE_CLASSIFICATION classification,
      Integer nuber, ClubMember clubMember, ANONYMITY anonymity, final Long clubId) {
  ...
  public static ClubMember createSampleClubMember(Long memberId, Long clubId, Long clubGradeId,
      Long attendanceStateId, Long clubMemberInformationId) {
